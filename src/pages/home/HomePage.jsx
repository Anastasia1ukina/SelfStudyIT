...
const flagOffsets = [
  ...
  {id: 5, topOffSet: 0.13, rightOffSet: 0.38, fileName: "scss.md", toolTipContent: <ScssToolTip />, label: "5. SCSS/PostCSS/Less" },
  ...
  {id: 11, topOffSet: 0.24, rightOffSet: 0.01, fileName: "react.md", toolTipContent: <ReactToolTip />, label: "11. React + Ecosystem" },
  {id: 12, topOffSet: 0.17, rightOffSet: 0.01, fileName: "typescript.md", toolTipContent: <TypescriptToolTip />, label: "12. TypeScript" },
  {id: 13, topOffSet: 0.11, rightOffSet: 0.005, fileName: "docker.md", toolTipContent: <DockerToolTip />, label: "13. Docker" },
  {id: 14, topOffSet: -0.07, rightOffSet: 0.015, fileName: "ssr.md", toolTipContent: <h1>hello</h1>, label: "14. SSR (NextJS)" },
]
